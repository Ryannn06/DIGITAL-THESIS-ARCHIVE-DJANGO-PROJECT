...
SECRET_KEY = 'django-insecure-50s992bldo9eg!-0481piu0^4&klj^fxfz_gn!pcl3&j#bxx%b'
...
CSRF_TRUSTED_ORIGINS = ['https://tupcthesisarchive.up.railway.app']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'libraryApp/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_PASSWORD = 'vpssjajceptsluod'
EMAIL_PORT = 587
...
#ACCOUNT_FORMS = {
#'signup': 'libraryApp.forms.CustomSignupForm',
#}
...
SESSION_EXPIRE_AFTER_ACTIVITY = True
